...
from django_useragent import utils
from django_useragent.utils import get_cache_key, get_user_agent, get_and_set_user_agent
from django_useragent.templatetags import user_agents
...
class MiddlewareTest(SimpleTestCase):
    ...
    def test_filters_can_be_loaded_in_template(self):
        ...
        self.assertContains(
            response, "Just making sure all the filters can be used without errors"
        )
    ...
    def test_get_cache_key(self):
        self.assertEqual(
            ...
            "django_useragent.c226ec488bae76c60dd68ad58f03d729",
        )
        self.assertEqual(
            get_cache_key(iphone_ua_string),
            "django_useragent.00705b9375a0e46e966515fe90f111da",
        )
    ...
    def test_custom_cache(self):
        ...
        self.assertIsInstance(
            utils.cache.get(get_cache_key(iphone_ua_string)), UserAgent
        )
